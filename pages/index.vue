...
<template>
    ...
    <div class="flex flex-col space-y-inner_space px-x_padding_page pt-inner_space">
            ...
            <div class="basis-1/2">
                <div class="flex flex-col space-y-inner_space">
                    <div class="basis-1/2 bg-background-light rounded-card_radius p-5">
                        <h1 class="text-5xl leading-tight font-bold">Unlocking digital possibilities, one line of code at a
                            time!</h1>
                    </div>
                    <div class="basis-1/2 bg-background-light rounded-card_radius p-5">
                ...
                <div class="flex flex-row h-full space-x-inner_space">
                    ...
                    <div class="basis-1/2">
                        <div class="flex flex-col space-y-inner_space h-full">
                            ...
                            <div class="grow bg-background-light rounded-card_radius p-3 space-y-3 flex flex-col">
                                <p class="text-2xl">Based in Milan</p>
                                <div class="bg-[url('~/assets/img/map.jpg')] bg-cover bg-center rounded-card_radius h-full">
                                </div>
                            </div>
                            <div class="flex-none flex flex-row space-x-inner_space">
        ...
        <div class="flex flex-row space-x-inner_space">
            <NuxtLink to="https://polimi-game-collective.itch.io/dark-unknown" target="_blank"
                ...
                <div class="basis-6/12 relative">
                    ...
                    <h3 class="text-lg">Developed a Unity-based roguelike video game
            ...
            <div
                ...
                <div class="basis-5/12"> <img src="~/assets/img/IoT.png"
                        class=" h-full w-full rounded-card_radius object-scale-down" /></div>
                <div class="basis-7/12 relative">
                    <h2 class="text-3xl">IoT</h2>
                    <h3 class="text-lg">Implement and showcase a network architecture similar to LoraWAN in
        ...
        <div class="flex flex-row space-x-inner_space">
            <div
                ...
                <div class="basis-12/12 relative">
                    ...
                    <h3 class="text-lg">Given a dataset and a classification task, introduce missing data ranging from 0% to
            ...
            <div
                ...
                <div class="basis-4/12"> <img src="~/assets/img/data-analysis.png"
                        class=" h-fit w-full rounded-card_radius object-cover" /></div>
                <div class="basis-8/12 relative">
                    <h2 class="text-3xl">Big and unstructured data project</h2>
                    <h3 class="text-lg">The aim of the pro ject is to implement a system that manages and queries a
        ...
        <div class="flex flex-row space-x-inner_space">
            <div class="basis-9/12 flex flex-col space-y-inner_space">
                ...
                <div class="flex flex-row space-x-inner_space h-full">
                    <div class="basis-2/3 flex flex-col space-y-inner_space">
                        <div class="basis-1/2 bg-purple rounded-card_radius p-5 flex flex-row space-x-7">
                            <div class="basis-4/12 bg-[url('~/assets/img/ai.png')] bg-contain bg-no-repeat bg-center">
                            </div>
                            <p class="basis-9/12">
                        ...
                        <div class="basis-1/2 bg-background-light rounded-card_radius p-6 flex flex-row space-x-7">
                            <div class="basis-4/12 bg-[url('~/assets/img/server.png')] bg-contain bg-no-repeat bg-center">
                            </div>
                            <p class="basis-9/12">
                    ...
                    <div class="basis-1/3 flex flex-col space-y-inner_space">
                        ...
                        <div class="bg-green rounded-card_radius p-3 flex flex-row space-x-2 items-center grow">
                            <div
                                class="grow bg-[url('~/assets/img/cyber-eye.png')] bg-contain bg-no-repeat bg-center w-full h-full">
                            </div>
                            <p>
